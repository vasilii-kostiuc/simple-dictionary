...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(['auth.flexible'])->group(function () {
        ...
        Route::post('trainings/{training}/terminate', [\App\Http\Controllers\Api\V1\Training\TrainingController::class, 'terminate'])->name('trainings.terminate');
        Route::get('trainings/{training}/summary', [\App\Http\Controllers\Api\V1\Training\TrainingController::class, 'summary'])->name('trainings.summary');
    ...
    Route::middleware(['auth.optional'])->group(function () {
        Route::post('match-links', [\App\Http\Controllers\Api\V1\Match\MatchLinkController::class, 'store'])
            ->middleware('throttle:match-links')
            ->name('match-links.store');
        Route::get('match-links/{matchLink}', [\App\Http\Controllers\Api\V1\Match\MatchLinkController::class, 'show'])->name('match-links.show');
