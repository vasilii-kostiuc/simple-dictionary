...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'completion_reason', type: 'string', nullable: true, enum: ['time_expired', 'steps_completed', 'all_players_left', 'forfeited', 'cancelled'], example: null),
