...
use App\Core\Training\Events\TrainingCompleted;
...
class TrainingCompletedListener
{
     ...
     */
    public function __construct(CompletionConditionFactory $completionConditionFactory, BrokerFactory $messageBrokerFactory)
    {
