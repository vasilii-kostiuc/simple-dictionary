...
class MatchLinkQrCodeGenerator
{
    public function generate(string $url): string
    {
        ...
        return <<<SVG
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 340" role="img" aria-label="Match link QR code">
    ...
    <text x="160" y="318" text-anchor="middle" font-size="10" font-family="Arial, sans-serif" fill="#334155">Scan or open the match link</text>
